 ...
 *     - 1 is Error
 */
int16_t MPU6050::MPU_Get_Temperature()
{
	uint8_t buf[2];
	int16_t raw;
	float temp;
 ...
 *     - 1 is Error
 */
uint8_t MPU6050::MPU_Get_Gyroscope(int16_t *gx, int16_t *gy, int16_t *gz)
{
	uint8_t buf[6], res;
 ...
 *     - 1 is Error
 */
uint8_t MPU6050::MPU_Get_Accelerometer(int16_t *ax, int16_t *ay, int16_t *az)
{
	uint8_t buf[6], res;
 ...
 *     - 1 is Error
 */
uint8_t MPU6050::MPU_Write_Len(uint8_t reg, uint8_t *data, uint8_t len)
{
	esp_err_t error;
	i2c_cmd_handle_t cmd = i2c_cmd_link_create();
	i2c_master_start(cmd);
 ...
 *     - 1 is Error
 */
uint8_t MPU6050::MPU_Read_Byte(uint8_t reg, uint8_t *res)
{
 ...
 *     - 1 is Error
 */
uint8_t MPU6050::MPU_Read_Len(uint8_t reg, uint8_t *buf, uint8_t len)
{
	esp_err_t error;
	i2c_cmd_handle_t cmd = i2c_cmd_link_create();
	i2c_master_start(cmd);
